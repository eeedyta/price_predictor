...
As expected the best estimator is Gradient Boosting with defined parameters max_depth: 95, min_samples_leaf: 15, n_estimators: 150. The result is not an amazing achievement 
...
but could be expected considering numerous of different parameters and lack of data.
